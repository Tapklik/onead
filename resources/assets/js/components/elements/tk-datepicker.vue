        ...
        >
            ...
            <div class="calendar-wrap">
                ...
                >
                    <div class="months-text">
                        <v-btn @click="goPrevMonth" icon>
                            <v-icon class="orange--text text--darken-3">chevron_left</v-icon>    
                        </v-btn>
                        <v-btn @click="goNextMonth" icon v-if="isCompact">
                            <v-icon class="orange--text text--darken-3">chevron_right</v-icon>
                        </v-btn>
            ...
            >
                <ul class="calendar_preset">
                    ...
                    >
                        <v-btn flat style="margin: 0px 0px;">
                            {{item.label}}
                        </v-btn>
                    </li>
                    <li>
                        <v-btn primary @click="setDateValue()">
                            {{captions.ok_button}}
                        </v-btn>
                    </li>
                </ul>
    ...
    export default {
        ...
        methods: {
            ...
            isDateSelected (r, i, key, startMonthDay, endMonthDate) {
                ...
                return (this.dateRange.start && this.dateRange.start.getTime() === currDate.getTime()) || (this.dateRange.end && this.dateRange.end.getTime() === currDate.getTime())
            },
